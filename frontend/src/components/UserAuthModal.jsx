...
import { deleteToken, host } from "../lib/helpers";
import { CloseIcon } from "../lib/Icons";
import { fetchLoggedInUser, uploadProfilePicture } from "../lib/CRUDs";

function UserAuthModal({ setShowAuthModal }) {
  ...
  const handleProfilePicUpload = async (ev) => {
    ...
    await uploadProfilePicture({ userData, formData });
    await fetchLoggedInUser(setUserData);
  };
